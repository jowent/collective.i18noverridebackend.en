# -*- coding: utf-8 -*-
"""Installer for the collective.i18noverridebackend.en package."""
...
setup(
    ...
    url='https://pypi.python.org/pypi/collective.i18noverridebackend.en',
    license='GPL version 2',
    packages=find_packages('src', exclude=['ez_setup']),
    namespace_packages=['collective', 'collective.i18noverridebackend'],
    package_dir={'': 'src'},
